@php
    $uris = ['student.home', 'student.login', 'supervisor.login', 'supervisor.home', 'department.login', 'weekly.following-form'];
@endphp
...
<body class="row">
    ...
    @elseif (\Request::route()->action['prefix'] == '/department' && !in_array(\Request::route()->getName(), $uris))
        @include('parts.header')
        @include('parts.department-sidebar')
    @else
        @include('parts.header')
