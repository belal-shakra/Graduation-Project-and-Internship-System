                ...
                <table class="table table-bordered border-dark">
                    ...
                    <tbody class="table-group-divider">
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#note[must be unique]">
                                    Click
                                </button>
                            </td>
                        </tr>
                        ...
                        <!-- Supervisor Note -->
                        <div class="modal fade" id="note[must be unique]">
                ...
                <div class="py-2 row">
                    <div class="col-sm-12 col-lg-6 col-xl-4 mb-2">
                        <div class="input-group border-a rounded">
                            ...
                            <input type="text" class="form-control bg-white" disabled value="supervisor's name">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-lg-6 col-xl-4 mb-2">
                        <div class="input-group border-a rounded">
                            ...
                            <input type="text" class="form-control bg-white" disabled value="supervisor's email">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="input-group border border-1 border-dark rounded" style="height: 8rem;">
                                ...
                                <textarea class="form-control bg-white" disabled>doc_note</textarea>
                            </div>
                        </div>
                    </div>
                </div>
